...
1. Upload the detection script `TLPCLEAR_check_script_cve-2025-6543-v1.6.sh` to a directory on your netscaler appliance such as /tmp (e.g. using the scp command)
2. Open a (SSH) shell to the appliance and navigate to the directory containing the detection script
3. Run the script as follows: `/bin/sh TLPCLEAR_check_script_cve-2025-6543-v1.6.sh`
